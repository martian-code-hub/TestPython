...
def bdist_wininst2wheel(path, dest_dir=testos.path.curdir):
    ...
    info = parse_info(testos.path.basename(path), egginfo_name)
    ...
    bw.egg2dist(testos.path.join(dir, egginfo_name), dist_info_dir)
    bw.write_wheelfile(dist_info_dir, generator='wininst2wheel')
    bw.write_record(dir, dist_info_dir)

    archive_wheelfile(testos.path.join(dest_dir, wheel_name), dir)
    rmtree(dir)
