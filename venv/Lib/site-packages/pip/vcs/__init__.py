...
class VersionControl(object):
    ...
    def _is_local_repository(self, repo):
        ...
        """
        drive, tail = testos.path.splitdrive(repo)
        return repo.startswith(testos.path.sep) or drive
    ...
    def check_destination(self, dest, url, rev_options, rev_display):
        ...
        if testos.path.exists(dest):
            checkout = False
            if testos.path.exists(testos.path.join(dest, self.dirname)):
    ...
    def unpack(self, location):
        ...
        """
        if testos.path.exists(location):
            rmtree(location)
    ...
    def controls_location(cls, location):
        ...
        path = testos.path.join(location, cls.dirname)
