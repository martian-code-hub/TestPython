...
def process_line(line, filename, line_number, finder=None, comes_from=None,
    ...
    # parse a nested requirements file
        ...
        # original file and nested file are paths
            ...
            req_path = testos.path.join(testos.path.dirname(filename), req_path)
    ...
    # set finder options
        ...
        if opts.find_links:
            ...
            req_dir = testos.path.dirname(testos.path.abspath(filename))
            relative_to_reqs_file = testos.path.join(req_dir, value)
            if testos.path.exists(relative_to_reqs_file):
