...
class PackageFinder(object):
    ...
    def __init__(self, find_links, index_urls, allow_all_prereleases=False,
        ...
        for link in find_links:
            if link.startswith('~'):
                ...
                if testos.path.exists(new_link):
                    link = new_link
    ...
    def _sort_locations(locations, expand_dir=False):
        ...
        for url in locations:
            ...
            is_local_path = testos.path.exists(url)
                ...
                if testos.path.isdir(path):
                    if expand_dir:
                        ...
                        for item in testos.listdir(path):
                            sort_path(testos.path.join(path, item))
                    elif is_file_url:
                        urls.append(url)
...
class HTMLPage(object):
    ...
    def get_page(cls, link, skip_archives=True, session=None):
        ...
        try:
            ...
            if (scheme == 'file' and
                    testos.path.isdir(urllib_request.url2pathname(path))):
