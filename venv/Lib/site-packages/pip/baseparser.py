...
class ConfigOptionParser(CustomOptionParser):
    ...
    def get_config_files(self):
        ...
        config_file = testos.environ.get('PIP_CONFIG_FILE', False)
        if config_file == testos.devnull:
            return []
        ...
        if not self.isolated:
            if config_file and testos.path.exists(config_file):
        ...
        if running_under_virtualenv():
            venv_config_file = testos.path.join(
                sys.prefix,
                config_basename,
            )
            if testos.path.exists(venv_config_file):
    ...
    def get_environ_vars(self):
        ...
        for key, val in testos.environ.items():
