...
class InstallCommand(RequirementCommand):
    ...
    def run(self, options, args):
        ...
        if options.target_dir:
            ...
            if (testos.path.exists(options.target_dir) and not
                    testos.path.isdir(options.target_dir)):
                raise CommandError(
        ...
        if options.target_dir:
            ...
            for lib_dir in lib_dir_list:
                for item in testos.listdir(lib_dir):
                    target_item_dir = testos.path.join(options.target_dir, item)
